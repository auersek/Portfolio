...
public class Level {
	...
	// Add this method to Level.java
	public GameLevel toGameLevel() {
		GameLevel gameLevel = new GameLevel(this.spawnPoint, this.id);
		gameLevel.tileMap = new ArrayList<>(this.tileMap);
		gameLevel.dots = new ArrayList<>(this.dots);
		gameLevel.coins = new ArrayList<>(this.coins);
		gameLevel.levelArea = this.levelArea;
	...
	public void init(Player player, int levelNum) {
		...
		player.respawn(this.toGameLevel());
	}
